...
class Namae:
    ...
    def run(self):
        hsh={}
        with open(self.args.infile,"r",encoding="euc-jis-2004") as f:
            for l in f:
                l=l.rstrip()
                if l.find(";;")==0:
                    continue
                ...
                kanji=re.sub(r';.*$','',items[1].replace('/',''))
...
def main():
    ...
    parser.add_argument('--infile', default="data/SKK-JISYO.fullname", type=str)
    parser.add_argument('--outfile', default="data/fullname.json", type=str)
