...
辞書の作成方法については，次のNotebookを参照のこと


1. [オープンソースの辞書から抽出](./dictionary.ipynb)
1. [異体字辞書を作成](./itaiji.ipynb)
1. [統計辞書を作成](./statistics.ipynb)
1. [姓名辞書を異体字辞書の見出しに統一](./replace.ipynb)
1. [すべての辞書を統合・変換](./merge.ipynb)
